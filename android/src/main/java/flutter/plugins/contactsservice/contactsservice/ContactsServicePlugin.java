...
public class ContactsServicePlugin implements MethodCallHandler, FlutterActivity.RequestPermissionsResultListener {


    private static final int REQUEST_CONTACTS = 3333;
    ...
    ContactsServicePlugin(ContentResolver contentResolver, Activity activity) {
    ...
    public static void registerWith(Registrar registrar) {
        ...
        ContactsServicePlugin plugin = new ContactsServicePlugin(registrar.context().getContentResolver(), registrar.activity());
    ...
    public void onMethodCall(MethodCall call, Result result) {
        if (!mPermissionManager.isPermissionGranted(Manifest.permission.READ_CONTACTS)) {
            mPermissionManager.askForPermission(
    ...
    public boolean onRequestPermissionsResult(
        ...
        if (requestCode == REQUEST_CONTACTS) {
            if (permissionGranted && mMethodCall != null && getContactResult != null) {
                handleMethodCall(mMethodCall, getContactResult);
            } else if (getContactResult != null) {
                //permission grant fail
